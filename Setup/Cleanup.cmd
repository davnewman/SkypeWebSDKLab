...
DEL "%MyDocuments%\Visual Studio 2015\Code Snippets\Visual C#\My Code Snippets\DeploymentAndAzure*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2015\Code Snippets\XML\My Xml Snippets\DeploymentAndAzure*.snippet" 2>NUL
